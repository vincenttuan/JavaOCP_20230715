...
public class DrinkMain6 {
	...
	public static void main(String[] args) {
		...
		int sum4 = calcDrinkSumAndPrint("巧克力牛奶", drinks);
		int sum5 = calcDrinkSumAndPrint("木瓜牛奶", drinks);
		int sum6 = calcDrinkSumAndPrint("拿鐵咖啡", drinks);
		int sum7 = calcDrinkSumAndPrint("焦糖咖啡", drinks);
		int sum8 = calcDrinkSumAndPrint("摩卡咖啡", drinks);
